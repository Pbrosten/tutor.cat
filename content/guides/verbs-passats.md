...
rounds: 5
---
Al B1 fem servir tres passats constantment. Dos descriuen accions *acabades* i només es diferencien pel **quan**; el tercer descriu el *rerefons*.
...
Marcadors: **avui, aquest matí, aquesta setmana, aquest mes, aquest any, fa una estona, ja / encara no, mai** (en tota la vida fins ara).

- Aquest matí **he anat** al metge.
- Aquesta setmana **hem tingut** molta feina.
- **Has estat** mai a Menorca? — No, no hi **he estat** mai.

La regla pràctica: *ahir* → perifràstic, *avui* → indefinit. En anglès és el mateix temps (*I went*); en català, no.
...
Arrels irregulars: ser → **era**, fer → **feia**, dir → **deia**, veure → **veia**, dur → **duia**, treure → **treia**, caure → **queia**, riure → **reia**, creure → **creia**.
...
|---|---|---|---|
| què | fet acabat | fet acabat | hàbit / descripció / rerefons |
| quan | període tancat (ahir) | període obert (avui) | qualsevol passat |
| exemple | Ahir **vaig veure** la Marta. | Avui **he vist** la Marta. | Abans **veia** la Marta cada dia. |
